...
def process_data(df):
    ...
    df['lead_time_of_registration']=df['lead_time_of_registration']=pd.cut(df['lead_hour_of_registration'],\
          [0,5,9,14,20,24], labels=['Dawn','Morning','Afternoon','Evening','Night'], right=False,include_lowest=True)
