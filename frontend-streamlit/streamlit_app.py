...
def run():
    ...
    Lead conversion refers to converting an inidividual that shows interest in your business(in this case app) into a paying customer. Its important to determine such individuals, and very important to predict which of your leads are likely to convert. 
    Companies are interested in targeting these leads that are likely to convert.These leads can  be targeted  with special deals and promotions to influence them to stay withthe company.
    This app predicts if a lead would convert. Lead converting means the lead succesfully registered with the app

    """)
    lead_utm_source= st.selectbox("Select lead utm source",('facebook', 'twitter', 'google_ads', 'youtube', 'newsletter','medium','instagram'))
